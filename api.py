...
@app.get("/grades/", response_model=list[CountryInfo])
async def get_grade(source_country_iso: str, grade: str, destination_iso: str):
    ...
    destination = destinations.get(destination_iso.upper())
    # Query data
    query = f"""
        SELECT 
